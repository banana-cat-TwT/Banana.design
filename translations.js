...
· 核心成果：验证三维辅助二维的流程化思路，探索媒介融合在动画创作中的可行性</small>`,
    ...
    en: {
        ...
        'about.edu': 'Education',
        'about.internship': 'Hands-on Experience',
...
const aboutExtrasData = {
    zh: {
        ...
        hobbies: {
            title: '兴趣爱好',
            intro: '曾有长辈提醒过我，涉猎过广容易样样不精。但我始终觉得，不能因为担心不够精深就停止探索，对什么有兴趣就去接触，这并没有什么不好，总不能因为害怕就压抑自己的好奇心和探索欲。我的学习方法一向是在一个方向上深入钻研的同时，也去接触其他领域，从过去到现在，一直都是如此。与其说自己会什么，我更习惯把东西做出来再说，平时学了什么不必声张，真正做出了东西再摆出来就好。无论是在日常生活还是职场上我也从不轻易对别人承诺，说出口的就一定是我有把握做到的，我不喜欢说大话，同样也对这样的人敬而远之。',
            items: [
