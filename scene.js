...
// Secondary fill light from the opposite side — warm bounce
const fillLight = new THREE.DirectionalLight('#ffe0b0', 0.6)
...
// Hemisphere: cool sky top, warm ground bounce
const hemiLight = new THREE.HemisphereLight('#b8d8ff', '#ffd090', 0.55)
scene.add(hemiLight)
