...
const archiveData = {
    ai: {
        ...
        '2026-08-22': { preview: 'OpenAI下调GPT-5.6 Sol API价格输入降20%输出降33%首次对最强旗舰模型动刀、英伟达上架550B指令跟随教师模型同日ARC-AGI-3公开关100%通关、WRC2026中国人形机器人半年出货超4万台全球占比97%但进厂稳定干活的不足5%、阿里拟配售800亿港元新股所得款项100%投向AI基础设施AI算力投入预期三年回本、高盛警告AI动能裂痕显现存储与数据中心板块估值缺口最具吸引力...', cards: [
    ...
    game: {
        ...
        '2026-08-22': { preview: 'GTA6泄露事件升级113GB本体文件扩散安全机构警告恶意软件钓鱼陷阱并发、战神制作人David Jaffe评黑神话钟馗像梦想项目索尼近年更像流水线海外首次把国产3A与索尼第一方并列、影之刃零进入发售倒计时66天二周目六十六天永久死亡模式曝光Steam愿望单破160万、GTA6昼夜循环或达144分钟为前作3倍直接影响光照天气NPC行为调度、PSBlackout玩家停机抗议启动一周不登录PSN反对索尼去光盘化Change.org请愿超35万签名...', cards: [
