...
const worksData = [
    ...
    },
    {
        ...
        image: 'images/luxun/微信图片_20260502015702_1174_2.jpg',
        tags: ['定格动画', '其他创作'],
        ...
        gallery: [
            'images/luxun/微信图片_20260502015703_1175_2.jpg',
            'images/luxun/微信图片_20260502015704_1176_2.jpg',
            'images/luxun/微信图片_20260502015706_1178_2.jpg',
            'images/luxun/微信图片_20260502015708_1179_2.jpg',
            'images/luxun/微信图片_20260502015927_1180_2.jpg',
            'images/luxun/微信图片_20260502015928_1181_2.jpg',
            'images/luxun/微信图片_20260502015935_1182_2.jpg',
            'images/luxun/微信图片_20260502015702_1174_2.jpg'
        ]
    },
    {
        id: 6,
...
const aboutData = [
    {
        ...
        company: '动画与游戏学院 · 导师：于瑾',
        description: '本科 · GPA：4/5 · 成绩排名：前10%\n研究方向：三维辅助二维动画创作·实时引擎视觉开发与混合媒介表达',
        details: '在中国美术学院动画专业学习期间，我系统学习了动画理论和实践技能，专注于三维辅助二维动画创作和实时引擎视觉开发。通过四年的学习，我掌握了从前期设定到后期成片的完整动画制作流程，为我的职业发展打下了坚实的基础。'
    },
    {
        id: 2,
        title: '毕业设计',
    ...
    },
    {
        ...
        company: '3D美术',
        description: '参与风格化角色及配饰资产制作与迭代，负责高模雕刻、低模拓扑、UV拆分、材质贴图调试、基础优化及版本调整。',
        details: '参与风格化角色及配饰资产制作与迭代，负责高模雕刻、低模拓扑、UV拆分、材质贴图调试、基础优化及版本调整；累计参与30+个项目资产制作，逐步建立起对风格化资产生产流程、风格适配及项目交付要求的理解；协助跟进QA问题、验收反馈及部分外包流程，具备一定跨岗位沟通、问题整理与流程理解能力；自主开发引擎一键多视角截图工具，并实践3ds Max减面工具，提升展示与模型优化环节效率；继续学习并实践UE材质蓝图、TA工具及AI辅助工作流，围绕LoRA、Tripo、Trellis等方向开展大模型训练与生成探索；使用团队内部三维生成平台"三谦"辅助资产生产，在外包配饰发包场景中将部分任务预估周期由约10-14天缩短至3–4天；将项目中的提效思路迁移至毕业设计与个人项目，扩展出视频帧一键截图功能，并搭建在线个人作品展示平台。'
    },
    {
        id: 4,
        title: '实习经历',
    ...
    },
    {
        ...
        details: 'WA IMAGING（哇嗷）是一家多领域的视觉公司，业务涉及品牌形象大片平面拍摄、动态视频摄影、三维数字短片、时尚活动拍摄等；主要服务宝格丽、倩碧、娇兰、阿玛尼等众多高奢品牌；协助主摄影师完成拍摄全流程工作，包括前期场景布置与拍摄道具制作、拍摄期间花絮跟拍及录像、后期影片剪辑与多平台宣传发布，并根据项目需求制作相关海报；实习期间系统学习了打光技巧、场景调度、画面构图及三维软件应用，并将相关经验运用于3D角色打光、背景布置及镜头机位设计中，进一步提升了视觉表达与空间组织能力。'
    },
    {
        id: 6,
        title: '项目经历',
    ...
    },
    {
        ...
        date: '2024年7月',
        company: '美术',
        description: '负责项目的静动态场景搭建与美术概念设计，在比赛周期内统筹时间与制作流程，运用3D场景辅助绘制，并结合手绘方式完成画面表现与视觉呈现。',
    ...
    },
    {
        id: 13,
        title: '项目经历',
        subtitle: '米哈游游戏美术OPENDAY',
        date: '2025年2月',
        company: '美术',
        description: '参与米哈游游戏美术OPENDAY活动，学习了解米哈游的游戏美术风格与制作流程，与行业前辈交流学习。',
        details: '参与米哈游游戏美术OPENDAY活动，学习了解米哈游的游戏美术风格与制作流程，与行业前辈交流学习。通过这次活动，我对米哈游的游戏美术制作标准和流程有了更深入的了解，也获得了宝贵的行业 insights。这次经历为我后来的职业发展提供了重要的参考。'
    },
    {
        id: 14,
        title: '项目经历',
