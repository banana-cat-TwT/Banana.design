...
const aboutData = [
    ...
    },
    {
        ...
        date: '2026年5月 - 至今',
        company: '游戏美术',
        description: '负责自研及小型团队项目全周期的2D/3D美术研发，覆盖写实、卡通等多种风格，独立负责资产从概念设计到引擎落地的全流程制作；对接策划、程序团队，统一美术规范与性能标准，输出资产实装上线，适配PC端/移动端的运行要求。',
        details: '负责自研及小型团队项目全周期的2D/3D美术研发，覆盖写实、卡通等多种风格，独立负责资产从概念设计到引擎落地的全流程制作。对接策划、程序团队，统一美术规范与性能标准，输出资产实装上线，适配PC端/移动端的运行要求。'
    },
    {
        id: 3,
        title: '实习经历',
